...
export default function DirectorSettingsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Настройки"
        description="Сроки резерва и оплаты, генерация сеансов и ссылки на документы."
        actions={
      ...
      {settings ? (
        <section className="director-panel">
          <div className="director-form-grid">
            ...
            <div className="director-field">
              <label>Окно генерации (дни)</label>
              <input
                type="number"
