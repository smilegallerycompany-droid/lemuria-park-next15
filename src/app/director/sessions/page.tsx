...
export default function DirectorSessionsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Сеансы"
        description="Сеансы на ближайшие недели и генерация из расписания."
        actions={
      ...
      <section className="director-panel" style={{ marginBottom: 18 }}>
        ...
        <div style={{ padding: 18 }}>
          <ConfirmCheckbox
            ...
            label="Подтверждаю генерацию сеансов на выбранное окно (уже созданные сеансы не перезаписываются)."
          />
          <button
            type="button"
